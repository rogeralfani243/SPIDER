...
if IS_HEROKU or not DEBUG:  # Production Heroku ou autre
    # ===== CONFIGURATION AWS S3 =====
    AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID')
    AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY')
    AWS_STORAGE_BUCKET_NAME = os.getenv('AWS_STORAGE_BUCKET_NAME')
    AWS_S3_REGION_NAME = os.getenv('AWS_S3_REGION_NAME', 'eu-west-3')  # Paris par défaut
    ...
    AWS_DEFAULT_ACL = 'public-read'  # ← CHANGEMENT IMPORTANT
    ...
    # ===== STATIC FILES (CSS, JS) =====
    # Sur Heroku, utilisez Whitenoise pour les static files
    STATIC_URL = '/static/'
